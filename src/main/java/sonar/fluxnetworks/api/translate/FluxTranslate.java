...
public class FluxTranslate implements ITranslationProvider {
    ...
    @Override
    public List<Translation> getTranslations(List<Translation> translations) {
        return FluxTranslate.translations;
    }
}
